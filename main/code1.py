...
# Load ImageKit image URLs
with open("ImageURLs.json", "r") as url_file:
        ...
        if counter != 0:
            if counter == 1:
                ...
                if studentInfo:
                    ...
                    print(f"❌ No student info found in DB for ID: {id}")
                    counter = 0
                    modeType = 0
